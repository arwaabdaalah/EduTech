...
Available values: light, dark, auto`);
	...
	if ("version" in data) {
		if (data.version === 3 || data.version === 4) store.version = data.version;
...
function patchClearTheme(base, clearTheme) {
	function iterate(base2, clearTheme2) {
		if (typeof clearTheme2 === "boolean") {
			if (typeof base2 === "object" && base2 !== null) for (const key in base2) base2[key] = iterate(base2[key], clearTheme2);
...
function patchApplyTheme(base, applyTheme) {
	function iterate(base2, applyTheme2) {
		if (typeof applyTheme2 === "string") {
			if (typeof base2 === "object" && base2 !== null) for (const key in base2) base2[key] = iterate(base2[key], applyTheme2);
...
function runApplyTheme(base, target, applyTheme) {
	function iterate(base2, target2, applyTheme2) {
		if (applyTheme2 === "replace") {
			if (typeof base2 === "object" && base2 !== null) for (const key in base2) base2[key] = iterate(base2[key], target2[key], applyTheme2);
			else return target2;
		}
...
function initThemeMode(props = {}) {
	...
	try {
		...
		window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", (e) => {
			...
			if ((storageMode2 === "light" || storageMode2 === "dark" || storageMode2 === "auto" ? storageMode2 : defaultMode) === "auto") {
				if (e.matches) document.documentElement.classList.add(className);
				else document.documentElement.classList.remove(className);
			}
		});
		window.addEventListener("storage", (e) => {
